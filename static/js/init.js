...
(function($) {
	...
	skel.init({
		reset: 'full',
		breakpoints: {
			'global':	{ range: '*', href: '/static/css/style.css', containers: 1140, grid: { gutters: 40 } },
			'wide':		{ range: '-1680', href: '/static/css/style-wide.css', containers: 960 },
			'normal':	{ range: '-1080', href: '/static/css/style-normal.css', containers: '95%', viewport: { scalable: false } },
			'narrow':	{ range: '-840', href: '/static/css/style-narrow.css', grid: { gutters: 30 } },
			'mobile':	{ range: '-640', href: '/static/css/style-mobile.css', grid: { collapse: true, gutters: 20 } }
		}
	});
